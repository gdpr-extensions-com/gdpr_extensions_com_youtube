...
class GdprManagerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     *
     * @var \GdprExtensionsCom\GdprExtensionsComYoutube\Domain\Repository\GdprManagerRepository
     */
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function showAction(\GdprExtensionsCom\GdprExtensionsComYoutube\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
     ...
     * action create
     *
     * @param \GdprExtensionsCom\GdprExtensionsComYoutube\Domain\Model\GdprManager $newGdprManager
     */
    public function createAction(\GdprExtensionsCom\GdprExtensionsComYoutube\Domain\Model\GdprManager $newGdprManager)
    {
     ...
     * @param \GdprExtensionsCom\GdprExtensionsComYoutube\Domain\Model\GdprManager $gdprManager
     */
    public function deleteAction(\GdprExtensionsCom\GdprExtensionsComYoutube\Domain\Model\GdprManager $gdprManager)
    {
    ...
    /**
     * @param \GdprExtensionsCom\GdprExtensionsComYoutube\Domain\Repository\GdprManagerRepository $gdprManagerRepository
     */
    public function injectGdprManagerRepository(\GdprExtensionsCom\GdprExtensionsComYoutube\Domain\Repository\GdprManagerRepository $gdprManagerRepository)
    {
